...
This repo contains the sources of the Chocolatey package for Web Filtering Proxy. The current package is available at https://community.chocolatey.org/packages/webproxy/2.3.0/
...
# download the MSI
Invoke-WebRequest -Uri "https://packages.diladele.com/webproxy/2.3.0.C58B/amd64/release/windows/webproxy-2.3.0.C58B_amd64.msi" -OutFile "webproxy-2.3.0.C58B_amd64.msi"

# calculate the sha256 hash of it
Get-FileHash "webproxy-2.3.0.C58B_amd64.msi"
...
Successfully created package 'm:\diladele\webproxy-chocolatey\src\webproxy\webproxy.2.3.0.nupkg'
```
...
choco push webproxy.2.3.0.nupkg -s https://push.chocolatey.org/
```