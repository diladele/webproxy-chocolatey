...
$url        = 'https://packages.diladele.com/webproxy/0.12.0.ED1E/amd64/release/windows/webproxy-0.12.0.ED1E_amd64.msi' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'webproxy*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
